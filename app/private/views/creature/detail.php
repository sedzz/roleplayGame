...
<body>
        ...
        <?php
                if (SessionUtils::loggedIn())
                    echo "<span class='badge badge-success  '> Has iniciado sesión: " . $_SESSION['user'] . "</span>";
                     ...
                     header('Location: ../../../public/views/creature/detail.php?id=' . $id);
                }
                ?>
    ...
    <div class="container">
            ...
            <div class="btn-group card-footer" role="group">
                <a type="button" class="btn btn-success" href="edit.php?id=<?php echo (isset($_GET["id"]) ? $creature->getIdCreature() : ""); ?>">Modificar</a>
                <a type="button" class="btn btn-danger" href="../../../controllers/creature/deleteController.php?id=<?php echo (isset($_GET["id"]) ? $creature->getIdCreature() : ""); ?>">Borrar</a>
            </div>
        </div>
    </div>
